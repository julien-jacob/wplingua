...
function wplng_start() {
	...
	if ( empty( wplng_get_api_data() ) ) {
		...
		// Dictionary: preview count + batch apply via AJAX (admin UI)
		add_action( 'wp_ajax_wplng_ajax_dictionary_preview', 'wplng_ajax_dictionary_preview' );
		add_action( 'wp_ajax_wplng_ajax_dictionary_apply_batch', 'wplng_ajax_dictionary_apply_batch' );
